...
#[derive(Debug)]
pub struct ApiHelperProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ApiHelperProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ApiHelper processing");
    
    let mut processor = ApiHelperProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ApiHelperProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ApiHelperProcessor::new(false);
